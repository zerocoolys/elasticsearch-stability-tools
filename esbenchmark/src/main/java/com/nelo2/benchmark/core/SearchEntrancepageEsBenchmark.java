...
public class SearchEntrancepageEsBenchmark extends AbstractEsBenchmark {
	...
	public String benchmark() {
		...
		// 过滤
		String source = TemplateFile.readFile("./doc/search-entrancepage-request");
	...
	@Override
	public String name() {
		return "SearchEntrancepageEsBenchmark";
	}
