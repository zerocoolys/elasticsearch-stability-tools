 ...
 *
 */
public class HistogramFacetSearchBenchmark extends JsonFileBenchmark {

	int QUERY_COUNT = 200;
	List<StatsResult> stats = new ArrayList<StatsResult>(QUERY_COUNT);

	public HistogramFacetSearchBenchmark(Settings settings, Client client) {
